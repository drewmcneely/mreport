...
This report is definitely more ``big picture'', and does not dive into much of the finer nuances of control and estimation.\todo{write this better}
...
One minor change to our langauge that can have significant impact is in the recasting of equations into functions\todo{expand on this}.
...
\newcommand{\FinVect}{\mathrm{FinVect}_{\mathds{R}}}
